                  ...
                  double c[4], int k)
{
  ...
  for (i3 = 1; i3 < n3-1; i3++) {
    for (i2 = 1; i2 < n2-1; i2++) {
    #pragma omp parallel for shared(r1, r2, i2, i3)
      for (i1 = 0; i1 < n1; i1++) {
                  ...
                  double a[4], int k)
{
  ...
  for (i3 = 1; i3 < n3-1; i3++) {
    for (i2 = 1; i2 < n2-1; i2++) {
  #pragma omp parallel for shared(u1, u2, i3, i2)
      for (i1 = 0; i1 < n1; i1++) {
...
#pragma omp parallel for shared(z) collapse(3)
  for (i3 = 0; i3 < n3; i3++) {
    for (i2 = 0; i2 < n2; i2++) {
    // #pragma omp simd
      for (i1 = 0; i1 < n1; i1++) {
