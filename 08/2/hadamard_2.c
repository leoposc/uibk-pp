...
void sequential_hadamard_product(double** a, double** b, double** c, size_t n) {
	int num_threads[] = { 1 };
	omp_set_num_threads(num_threads[0]);
	...
	printf("%zu n, sequentiell, time: %f seconds \n", n, end_time - start_time);
}
...
int main(int argc, char** argv) {
	...
	sequential_hadamard_product(a, b, c, n);
